        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="emails">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <router-link to="/addDepartment" class="nav-link">Add Department</router-link>
                </li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="Employee">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <router-link to="/addEmployee" class="nav-link">Add Employee</router-link>
                </li>
                <li class="nav-item">
                  <router-link to="/allEmployee" class="nav-link">All Employee</router-link>
                </li>
              </ul>
            </div>
          </li>
